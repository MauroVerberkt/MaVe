...
public class NonExhaustiveUnionMatchCodeFixTests
{
    ...
    public async Task SwitchExpression_MissingVariants_AddsMissingArms()
    {
        ...
        var expected = CSharpCodeFixVerifier<NonExhaustiveUnionMatchAnalyzer, NonExhaustiveUnionMatchCodeFixProvider>
            .Diagnostic(DiagnosticId)
            .WithLocation(0)
            .WithArguments("Prospect, Supplier");

        await CSharpCodeFixVerifier<NonExhaustiveUnionMatchAnalyzer, NonExhaustiveUnionMatchCodeFixProvider>
